        ...
        <div class="container div-card">
            ...
            <form action="" enctype="multipart/form-data" method="post">
                ...
                <div class="form-input-div">
                    ...
                    <input disabled class="form-control disabled" type="text" id="username" name="username" value="<?php echo $user->userName; ?>" placeholder="User Name" required="">
                </div>
                </div>
                ...
                <div class="form-input-div">
                    ...
                    <input disabled class="form-control disabled" type="text" id="isbnNumber"  value="<?php echo $book->isbnNumber; ?>"  name="isbnNumber" placeholder="Book Name" required="">
                </div>
                </div>
               ...
               <div class="form-input-div">
                    ...
                    <textarea class="form-control" id="comments" name="comments" placeholder="comments"><?php echo $comments; ?></textarea>
                </div>
                </div>
                </div>
