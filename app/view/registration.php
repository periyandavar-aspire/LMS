                        ...
                        <section class="form-card">
                            ...
                            <form action="/user/signup" onsubmit="registrationFormValidator(event);" method="POST">
                                ...
                                <div class="form-input-div">
                                    ...
                                    <input class="form-control" pattern="^[789]\d{9}$" type="text" id="mobile" name="mobile" maxlength="10" placeholder="Mobile Number..." autocomplete="off" required="">
                                </div> 
                                <div class="form-input-div">
                                ...
                                <div class="form-input-div">
                                    ...
                                    <input class="form-control" onkeyup="passStrength('password')" minlength="6" type="password" id="password" name="password" placeholder="********" autocomplete="off" required="">
                                ...
                                <div class="form-input-div">
                                    ...
                                    <input class="form-control"  onkeyup="checkConfirm('password','confirmPassword','errormsg')" minlength="6" type="password" id="confirmPassword" name="confirmpassword" placeholder="********" autocomplete="off" required="">
                                    <span id="errormsg" style="color:red"></span>
                                </div>   
                                <div class="form-input-div">
                                        <label>Verification code <span class="required-star">*</span></label>
                                        <input type="text" id="vercode" name="captcha" maxlength="5" autocomplete="off" placeholder="Verification Code..." required="" style="width: 150px; height: 25px;">&nbsp;<img id="signImg" src='<?php echo Utility::baseURL() . "/home/captcha"; ?>'>
                                </div>                                 
