            ...
            <div class="cols col-1">
                <div class="text-container">
                    ...
                    <ul class="unstyle-list">
                        <li>
                            <a href="<?php echo $footer->fbUrl;?>"
                                target="_blank"><i class="fa fa-facebook-square symbols"
                                    aria-hidden="true"></i>&nbsp;&nbsp;Facebook</a>
                        </li>
                        <li>
                            <a href="<?php echo $footer->instaUrl;?>"
                                target="_blank"><i class="fa fa-instagram symbols"
                                    aria-hidden="true"></i>&nbsp;&nbsp;Instagram</a>
                        </li>
                        <li>
                            <a href="<?php echo $footer->ytUrl;?>"
                                target="_blank"><i class="fa fa-youtube-play symbols"
