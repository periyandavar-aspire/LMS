...
<article class="main">
                    ...
                    <table class="tab_design">
                        ...
                        <tbody>
                            ...
                            <tr id="<?php echo $book->id;?>">
                                ...
                                <td><?php echo $book->createdAt?>
                                </td>
                                <td><?php echo $book->updatedAt;?>
                                </td>
                                <td>
                                    <div class="checkbox"><input type="checkbox"
                                            onchange="changeStatus(event,'/books/changeStatus/<?php echo $book->id;?>');"
    ...
    echo "checked";
                                ...
                                <td>
                                    ...
                                    <button type="button"
                                        onclick="deleteItem('/books/delete/<?php echo $book->id;?>');"
