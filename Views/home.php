    ...
    <body> 
    	<header>
            ...
            <div class="drop-down" id="nav-drop-down">
                <ul>
                    ...
                    <li><a href="#"><i class="fa fa-book" aria-hidden="true"></i> Authors</a></li>
                    <li><a href="#"><i class="fa fa-book" aria-hidden="true"></i> Books</a></li>
                    <li><a href="#"><i class="fa fa-book" aria-hidden="true"></i> Issue Books</a></li>
                    <li><a href="#"><i class="fa fa-book" aria-hidden="true"></i> Reg. Users</a></li>
        ...
        <nav>
            <ul>
                <li><a href="#"><i class="fa fa-home" aria-hidden="true"></i> Home</a></li>
                <li><a href="#"><i class="fa fa-user-circle" aria-hidden="true"></i> Profile</a></li>
                <li><a href="#"><i class="fa fa-list-alt" aria-hidden="true"></i> Categories</a><i class="fa fa-caret-down down-arrow" aria-hidden="true"></i></li>
                <li><a href="#"><i class="fa fa-user-o" aria-hidden="true"></i> Authors</a><i class="fa fa-caret-down down-arrow" aria-hidden="true"></i></li>
                <li><a href="#"><i class="fa fa-book" aria-hidden="true"></i> Books</a><i class="fa fa-caret-down down-arrow" aria-hidden="true"></i></li>
                <li><a href="#"><i class="fa fa-address-book" aria-hidden="true"></i> Issue Books</a><i class="fa fa-caret-down down-arrow" aria-hidden="true"></i></li>
                <li><a href="#"><i class="fa fa-users" aria-hidden="true"></i> Reg. Users</a><i class="fa fa-caret-down down-arrow" aria-hidden="true"></i></li>
                <li><a href="#"><i class="fa fa-plus" aria-hidden="true"></i> Add</a></li>
                <li><a href="#"><i class="fa fa-pencil-square" aria-hidden="true"></i> Manage</a></li>
                <li><a href="#"><i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a></li>
            </ul>
        </nav>
        <article class="main">
